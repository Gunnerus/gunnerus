...
urlpatterns = [
	...
	#url(r'^invoices/overview/$', login_required(CruiseCreateView.as_view()), name='invoices'),
	#url(r'^invoices/history/$', login_required(CruiseCreateView.as_view()), name='invoices'),
	#url(r'^invoices/history/from-(?P<start_date>\d{4}\-(0?[1-9]|1[012])\-(0?[1-9]|[12][0-9]|3[01]))-to-(?P<end_date>\d{4}\-(0?[1-9]|1[012])\-(0?[1-9]|[12][0-9]|3[01]))$', login_required(CruiseCreateView.as_view()), name='invoices-for-period'),
