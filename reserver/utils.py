...
default_email_templates = [
	['Cruise approved', 'Cruise administration', '{% if cruise_name %}Your cruise {{ cruise_name }} has been approved.{% else %}A cruise you are administrating has been approved.{% endif %}', None, None, True, False],
	['Cruise information approved', 'Cruise administration', '{% if cruise_name %}Your cruise {{ cruise_name }} has had its information approved.{% else %}The information of a cruise you are administrating has been approved.{% endif %}', None, None, True, False],
	['Cruise information unapproved', 'Cruise administration', '{% if cruise_name %}Your cruise {{ cruise_name }} has had its information unapproved.{% else %}A cruise you are administrating has had its information unapproved.{% endif %}', None, None, True, False],
	['Cruise rejected', 'Cruise administration', '{% if cruise_name %}Your cruise {{ cruise_name }} has been rejected.{% else %}A cruise you are administrating has been rejected.{% endif %}', None, None, True, False],
	['Cruise unapproved', 'Cruise administration', '{% if cruise_name %}Your cruise {{ cruise_name }} has been unapproved.{% else %}A cruise you are administrating has been unapproved.{% endif %}', None, None, True, False],
